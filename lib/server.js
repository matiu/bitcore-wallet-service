      ...
      self.getWallet({}, function(err, wallet) {
        ...
        if (wallet.coin == 'bch' && wallet.network == 'livenet') {
          status.serverMessage = {
            ...
            body: 'On Nov 15th, the Bitcoin Cash network will experience a protocol update hard fork. Learn more about how this will affect your wallet and how to keep your funds safe during the fork.',
