  ...
  async.parallel([
    ...
    function(next) {
      self.getWallet({}, function(err, wallet) {
        ...
        if (wallet.coin == 'bch' && wallet.network == 'livenet') {
          status.serverMessage = {
            //title: 'Upcoming Bitcoin Cash Fork',
            //body: 'On Nov 15th, the Bitcoin Cash network will experience a protocol update hard fork. This will affect your wallet. Some precautions need to be taken  to keep your funds safe during the fork.',
...
//            body: 'The Bitcoin Cash network is currently undergoing disruptions due to protocol changes. We advise against sending or receiving BCH payments until the fork is over',
            title: 'Bitcoin Cash Protocol Change Update',
            body: 'We have restarted our wallet servers to enable transactions. Our servers continue to use the Bitcoin ABC software. Caution: transactions may send coins on both the ABC and SV chains.',
            link: 'https://support.bitpay.com/hc/en-us/articles/360019251611-What-BitPay-and-Copay-wallet-users-need-to-know-about-the-November-15th-Bitcoin-Cash-hard-fork-',
          };
        }
        next();
      });
